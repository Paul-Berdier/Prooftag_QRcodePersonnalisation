...
def laboratory_profiles() -> list[dict[str, Any]]:
    ...
    return [
            ...
            "tools": {
                ...
                "settings": {
                    **stage2_at(1.0, target="binary_exact"),
                    ...
                    "srpg_preview_interval": 1,
                    "srmpgd_protocol": "paper_equations",
                    # E033 is a one-update memory/mechanism gate. Four updates are authorized
                    # only after this exact FP16/FP32 pair proves a finite non-zero Eq. 14 step.
                    "srmpgd_max_iterations": 1,
                    "srmpgd_step_size": 1000.0,
        ...
        {
            "id": "e034_equation_srmpgd_fp16",
            "name": "E034 — Eq. 13-14 ×4, VAE modèle",
            "backend": "controlnet",
            "enabled": False,
            "output_variant": "srmpgd",
            "reuse_stage1": True,
            ...
            "description": (
                "Ablation E034 désactivée : même Stage 2, mêmes équations et même "
                "précision modèle que le témoin E033 FP16, prolongés à quatre mises "
                "à jour pour mesurer la trajectoire SRL/LPIPS."
            ),
        },
        {
            "id": "e034_equation_srmpgd_fp32",
            "name": "E034 — Eq. 13-14 ×4, VAE FP32",
            "backend": "controlnet",
            "enabled": False,
            "output_variant": "srmpgd",
            "reuse_stage1": True,
            ...
            "description": (
                "Ablation E034 désactivée : même Stage 2, mêmes équations et même "
                "VAE FP32 que la branche E033 FP32, prolongés à quatre mises à jour "
                "pour isoler la trajectoire numérique SRL/LPIPS."
            ),
        },
        {
        ...
        {
            "id": "diffqrcoder_srmpgd_robust",
            "name": "E020 — SR-MPGD robuste",
            "backend": "controlnet",
            "enabled": True,
            "output_variant": "srmpgd",
            "reuse_stage1": True,
            ...
            "tools": {
                ...
                "settings": {
                    **stage2_at(0.65),
                    ...
                    "srmpgd_max_high_saturation_ratio_increase": 0.05,
                    "srmpgd_max_rgb_clipped_channel_ratio_increase": 0.01,
                    "srmpgd_robust_blur_weight": 1.0,
                    "srmpgd_robust_blur_kernel": 3,
                    "srmpgd_robust_downscale_weight": 1.0,
                    "srmpgd_robust_downscale_factor": 0.75,
                    "srmpgd_robust_brightness_weight": 0.5,
                    "srmpgd_robust_brightness_low": 0.80,
                    "srmpgd_robust_brightness_high": 1.20,
                    "srmpgd_robust_contrast_weight": 1.0,
                    "srmpgd_robust_contrast_factor": 0.75,
                },
            },
            "description": (
                "E020 : même latent SRPG et mêmes gardes que le témoin E019, "
                "mais la loss officielle est moyennée avec flou, réduction, "
                "luminosité et contraste différentiables."
            ),
        },
        {
            "id": "diffqrcoder_auto",
